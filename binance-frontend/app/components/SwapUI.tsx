                            ...
                            <div className="flex flex-col relative">
                                ...
                                <div className="flex flex-row absolute right-1 top-1 p-2">
                                    <div className="relative">
                                        <img loading="lazy" src={`https://backpack.exchange/_next/image?url=%2Fcoins%2F${symbols[1].toLowerCase()}.png&w=48&q=75
`} className="w-6 h-6" />
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col relative">
                            ...
                            <div className="flex flex-row absolute right-1 top-1 p-2">
                                <div className="relative">
                                    <img loading="lazy" src={`https://backpack.exchange/_next/image?url=%2Fcoins%2F${symbols[0].toLowerCase()}.png&w=48&q=75
`} className="w-6 h-6" />
                                </div>
                            </div>
                        </div>
