...
import { CANCEL_ORDER, CREATE_ORDER, GET_DEPTH, GET_OPEN_ORDERS, GET_TICKER, GET_TRADES, MessageFromApi, ON_RAMP } from "../types/fromApi";
        ...
        switch (message.type) {
            ...
            case GET_TICKER:
                try {
                    ...
                    RedisManager.getInstance().sendToApi(clientId, {
                        type: "TICKER",
                        payload: orderbook.getTicker().toString()
                    });
                } catch (e) {
                    console.log(e);
                    RedisManager.getInstance().sendToApi(clientId, {
